...
public class SellerReviewsGigsAdpater extends BaseAdapter {
    ...
    private List<POSTSellerReviews.Datum> SellerReviews;
    String commentTime = "";
    SimpleDateFormat dateFormat = new SimpleDateFormat(
            "yyyy-MM-dd HH:mm:ss");


    public SellerReviewsGigsAdpater(Context mContext, List<POSTSellerReviews.Datum> SellerReviews) {
    ...
    @Override
    public POSTSellerReviews.Datum getItem(int position) {
